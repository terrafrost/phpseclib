...
abstract class PuTTY extends Progenitor
{
     ...
     *
     * @access public
     * @param \phpseclib\Math\Common\FiniteField $privateKey
     * @param \phpseclib\Crypt\ECDSA\BaseCurves\Base $curve
     * @param \phpseclib\Math\Common\FiniteField[] $publicKey
     * @param string $password optional
     * @return string
     */
    public static function savePrivateKey(FiniteField $privateKey, BaseCurve $curve, array $publicKey, $password = false)
    {
